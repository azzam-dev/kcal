...
> محرك حساب السعرات والـmacros مكتمل ومُتحقَّق منه، والمصادقة والملف الشخصي مبنيان
> والـschema مطبَّق على القاعدة الحية والتسجيل مُجرَّب طرفاً لطرف (١٣٥ اختباراً يمر).
> **اختبارات RLS مكتوبة ولم تُشغَّل بعد** — تحتاج مفتاحاً في `.env.test.local`.
> **لا يوجد تسجيل طعام ولا onboarding بعد.**
